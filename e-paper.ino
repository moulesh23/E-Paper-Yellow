...
void epaperUpdate() {
  ...
  //*************Product Name*******************
  ePaper.fillRect(101,0,640-101,100,GxEPD_BLACK);  
  ePaper.setTextColor(GxEPD_WHITE);
  const GFXfont* h = &FreeMonoBold24pt7b;
  ePaper.setFont(h);
  ePaper.setCursor(300,70);
  ePaper.println(comm_name);

  //************Border**************************
  ePaper.fillRect(0,98,101,2,GxEPD_BLACK);
  ePaper.fillRect(450,100,2,201,GxEPD_BLACK);
  ePaper.fillRect(225,100,2,201,GxEPD_BLACK);
  ...
  ePaper.setTextColor(GxEPD_BLACK);
  ePaper.setFont(f);
  ePaper.setCursor(235,130);
  ePaper.println("MRP \t");
  const GFXfont* g = &FreeMonoBold18pt7b;
  ePaper.setFont(g);
  ePaper.setTextColor(GxEPD_RED);
  ePaper.setCursor(235,170);
  ePaper.println(prev_price);

  ePaper.setTextColor(GxEPD_BLACK);
  ePaper.setFont(f);
  ePaper.setCursor(235,220);
  ePaper.println("Offer Price \t");
  ePaper.setFont(g);
  ePaper.setTextColor(GxEPD_RED);
  ePaper.setCursor(235,260);
  ...
  ePaper.setTextColor(GxEPD_RED);
  ePaper.setFont(h);
  ePaper.setCursor(500,170);
  ePaper.println(dis);
  ePaper.drawBitmap(gImage_offer, 480, 200, 130, 130, GxEPD_RED);
  ePaper.update();
  ...
  //************Server Name*********************
  ePaper.fillRect(0,301,640,384-301,GxEPD_BLACK);
  //const GFXfont* g = &FreeMonoBold12pt7b;
  ePaper.setTextColor(GxEPD_RED);
  ePaper.setFont(f);
  ePaper.setCursor(20,350 );
